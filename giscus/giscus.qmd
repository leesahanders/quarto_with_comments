...
<!-- setwd("C:/Users/LisaAnders/Documents/git/quarto_with_comments/giscus") -->

<script src="https://giscus.app/client.js"
        data-repo="leesahanders/quarto_with_comments"
        data-repo-id="R_kgDOLIJtnA"
        data-category="Show and tell"
        data-category-id="DIC_kwDOLIJtnM4Ch1g2"
...
Users can add comments to the document using a couple of the extension options: hyothes.is, giscus, or utterances. Each interacts with the document in a different way. Note that both giscus and utteranes require github to set up the extension and all commenting users to have gituhub accounts. 

Learn more about adding comments with: <https://quarto.org/docs/output-formats/html-basics.html#commenting> 
...
We can also interactively embed shiny apps using shinylive so that they will render within our static document. Pretty cool, right? For more check out r-shinylive: <https://posit-dev.github.io/r-shinylive/> 
